...
**Category:** Business  
**Package:** `com.mohithash.byok.renewalradar`  
**Short description (≤80):** Spot churn early, renew on time, expand naturally

## Full description
Renewal Radar is a customer success manager's toolkit: health scores from messy notes, 30/60/90 onboarding plans, renewal playbooks and save plans for accounts going quiet.

WHAT'S INSIDE
• Health check — Notes + usage → score
• Onboarding plan — 30/60/90 to first value
• Renewal playbook — Start 120 days out
• Save plan — They said they might leave
• Expansion signals — Find the upsell in the notes
