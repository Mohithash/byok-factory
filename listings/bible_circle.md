...
• Background notes — History, culture, words
• Sermon → discussion — Turn Sunday's message into questions
• Handle a hard question — When someone asks the tough one
• Plan a series — Weeks of studies that build
...
- 🎧 **Sermon → discussion** — Turn Sunday's message into questions
- 🤔 **Handle a hard question** — When someone asks the tough one
- 🗓️ **Plan a series** — Weeks of studies that build
